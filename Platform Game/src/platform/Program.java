...
public class Program {
	...
	public static void main(String[] args) throws Exception {
		...
		// Create components
		Loader loader = new BufferedLoader(new FileLoader("/home/ahla/eclipse-workspace/Platform Game/res/", DefaultLoader.INSTANCE));
		Display display = new SwingDisplay();
		display.setBackground(Color.BLUE);
		//PlaySound sound = new PlaySound("res/GrassLandsTheme");
		try {
